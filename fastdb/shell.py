...
def load_databases(path:str="db"):
   ...
   if path_collection.children_amount != 0:
...
def run_shell(dbs_path:str):
   ...
   banner = f'''fastdb Shell {version}
Type "dbs.children" to list your databases, Or "browse" to browse one of your databases'''
