...
parser = argparse.ArgumentParser("SpeeddDB", description=f"fastdb CLI {version}")

parser.add_argument('-v', '--version', action='version', version=f'fastdb {version}', help='Show version')
